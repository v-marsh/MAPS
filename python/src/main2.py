...
SRC_LOC = r"C:\Users\vidar\OneDrive - University of Bristol\Documents\Uni_2021_2022\MAPS_experiment\code\python_old\src"
    ...
    while True:
        ...
        # Load new PT curve
            ...
            prog_data.saved_ptc[ptc_name] = ptc.get_ptc(\
                ...
                sort=sorting)
            ptc.save_ptc_object(prog_data.saved_ptc.get(ptc_name), settings.src_path)
        ...
        # Analyse 
            ...
            if analyse_choice == "1":
                ...
                iat.get_offset(prog_data.saved_runs.get(run_name).frame_arr)
                sleep(1)
                continue
                ...
                if len(prog_data.saved_runs(run_name)) != 1:
                    ...
                    run_num = 1
                iat.get_noise(prog_data.saved_runs(run_name).frame_arr)
                sleep(1)
                continue
